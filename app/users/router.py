# Здась представлены роуты на урлы взянные с сущностью юзер
...
from app.exceptions import UserAlreadyExistsException, IncorrectEmailOrPasswordExecption
...
async def login_user(user_data: SUserAuth, response: Response):
    ...
    if not user:
        raise IncorrectEmailOrPasswordExecption
